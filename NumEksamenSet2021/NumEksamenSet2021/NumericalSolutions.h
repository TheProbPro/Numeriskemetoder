...
namespace NumericalSolutions
{
	...
	// Midpoint method
	VecDoub Midpoint(VecDoub(*f)(double x0, double x1, double x2, double x3), double x0, double x1, double x2, double x3, int a, int b, VecDoub h, VecDoub& ans) {
		// Declaration of variables
		VecDoub Fxy0(4), Fxy1(4), FxyNew(4), FxyHalf(4), xy(4);
		double stepsize = 0;
